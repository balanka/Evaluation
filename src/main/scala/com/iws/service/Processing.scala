...
object  Processing  {
  ...
  trait ProcessTransaction [A<:IWS] {
    ...
    private [Processing] def postDebit ( periode:Int, accountId:String, amount:BigDecimal, company:String, currency:String , modelId:Int):PeriodicAccountBalance =
      postAccount(periode, accountId, amount,true, company,currency, modelId )
    private [Processing]  def postCredit ( periode:Int, accountId:String,amount:BigDecimal , company:String, currency:String, modelId:Int )=
      postAccount(periode, accountId, amount,false, company,currency,modelId )
    private [this] def  postAccount(periode:Int, accountId:String, amount:BigDecimal,isDebit:Boolean, company:String, currency:String, modelId:Int)
      = {
